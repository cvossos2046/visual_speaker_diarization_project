...
def main():
	video = "NET20070330_thlep_1_4"

	camera = cv2.VideoCapture('../gridnews/visual_svm_test_set/' + video + '.mkv')
	...
	file_path = "optical_flow_features_test/" + video + "/optical_flow_features_test.txt"
	...
	optical_flow_features_test = open(file_path, "w")
						...
						for (name, (i, j)) in face_utils.FACIAL_LANDMARKS_IDXS.items():
							if (name == "mouth"):
								...
								if frame_number == first_frame_with_faces:
									...
									optical_flow_features_test.write(str(frame_number) + ' ' + str(objectID) + '\n')

									for el in mag_reduced_dim.flatten():
										optical_flow_features_test.write(str(el) + ' ')
									optical_flow_features_test.write('\n')
